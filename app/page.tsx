...
export default function Home() {
  ...
  function randomTarget(prev = null) {
    let next;
    do {
              ...
              <div className="text-center">
                ...
                <p
                  className={`text-xl font-black ${
                    combo >= 5 ? "text-[#60a5fa] animate-pulse" : "text-[#a78bfa]"
                  }`}
                >
                  {combo > 1 ? `x${combo}` : "-"}
                </p>
              ...
              <div className="text-right">
                ...
                <p
                  className={`text-4xl font-black ${
                    timeLeft <= 10 ? "text-red-400 animate-pulse" : "text-[#60a5fa]"
                  }`}
                >
                  {timeLeft}
                </p>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-[#60a5fa]/35 bg-[#080b18]/90 shadow-[0_0_90px_rgba(96,165,250,0.25)] backdrop-blur-xl p-5 text-center">
            ...
            <div className="relative">
              ...
              <p className="mt-5 text-[#dbeafe] text-sm leading-6">
                ...
                <span className="text-[#a78bfa] font-black">focus</span> till the end.
              </p>
