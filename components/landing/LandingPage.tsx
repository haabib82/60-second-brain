        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-4">
                {GAMES.map((game, index) => {
                    ...
                    // Determine if this specific card is the absolute last one standing alone
                    const isLastItem = index === GAMES.length - 1;
                    const isTotalOdd = GAMES.length % 2 !== 0;
                    const isTotalRemainderOneInThree = GAMES.length % 3 === 1;
                    ...
                    return (
                        ...
                        >
                            <Link href={`/play/${game.id}`} className="block h-full">
                                {/* ... Rest of your unchanged card inner UI code ... */}
